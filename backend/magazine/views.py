...
#         print(f"🆕 Creating post for user: {self.request.user.username}")
        
#         # Get or create student profile
#         profile = get_or_create_student_profile(self.request.user)
        
#         print(f"✅ Using profile: {profile.student_id}, Verified: {profile.is_verified}")
        
#         if not profile.is_verified:
#             raise Exception('Only verified students can create posts')
        
#         serializer.save(author=profile)
#         print(f"🎉 Post created successfully: {serializer.data.get('title')}")
...
class PostViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_context(self):
        """
        FIXED: Pass request context to serializer for proper URL generation
        """
